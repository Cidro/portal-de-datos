...
class Version20140226114532 extends AbstractMigration {
    ...
    public function up(Schema $schema) {
        ...
        ");
        $this->addSql("ALTER TABLE recurso_junar ADD CONSTRAINT FK_6E080871E52B6C4E FOREIGN KEY (recurso_id) REFERENCES recurso (id) ON DELETE CASCADE");
    ...
    public function postUp(Schema $schema) {
        ...
        $sqlInsert = "INSERT INTO recurso_junar (recurso_id, junar_guid, title, description, tags, source, category, meta_data, table_id, created_at, updated_at)" . " VALUES (:recurso_id, :junar_guid, :title, :description, :tags, :source, :category, :meta_data, :table_id, :created_at, :updated_at)";
    ...
    public function down(Schema $schema) {
        ...
        $this->addSql("DROP TABLE recurso_junar");
